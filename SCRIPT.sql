...
ALTER SEQUENCE provinces_id_province_seq RESTART WITH 2000 INCREMENT BY 1;
...
SELECT evolution.id_pays,pays.nom_pays,sum(evolution.positifs) as positifs,sum(evolution.gueris) as gueris
,sum(evolution.deces) as deces FROM Evolution INNER JOIN pays ON evolution.id_pays = pays.id_pays GROUP BY
evolution.id_pays,pays.nom_pays;
...
evolution.id_pays = pays.id_pays GROUP BY evolution.id_province,evolution.id_pays,pays.nom_pays,provinces.nom_province;
